...
export const About = (): JSX.Element => {
  ...
  return (
    <div ref={containerRef} className='relative h-[150vh] bg-black font-fort'>
      ...
      <div className='absolute top-0 left-0 w-full z-0 h-fit pointer-events-none'>
        <img alt='Background' className='w-full h-auto' src={HeroSection} />

        {/* Subtle overlay texture - repeated or stretched */}
        <div
          className='absolute inset-0 w-full h-full mix-blend-overlay opacity-10'
          style={{
            backgroundImage: `url(${image2727})`,
